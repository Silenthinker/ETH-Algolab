/* Algorithm
 * Find nearest distance between all pairs of graypes
 * Note that lexicographically smallest position condition
 * prevent running in circles and there must be a pair of graypes
...
void test_case(int n) {
    ...
    for (auto e = trg.finite_edges_begin(); e != trg.finite_edges_end(); ++e) {
        min_squared_distance = std::min(min_squared_distance,trg.segment(*e).squared_length());
    }
